...
**Issue**: "Connection refused" error for Ollama
- **Solution**: Ensure Ollama is running: `ollama serve`

**Issue**: ChromaDB errors on startup
- **Solution**: Delete `data/vector_db/` directory and restart to reinitialize

**Issue**: Slow recommendations
- **Solution**: Reduce `max_tokens` in `config.yaml` or use a faster model
